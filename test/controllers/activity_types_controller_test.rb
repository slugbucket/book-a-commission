...
class ActivityTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_type" do
    assert_difference('ActivityType.count') do
      post activity_types_url, params: { activity_type: { color: @activity_type.color, description: @activity_type.description, name: @activity_type.name } }
    end
  ...
  test "should update activity_type" do
    patch activity_type_url(@activity_type), params: { activity_type: { color: @activity_type.color, description: @activity_type.description, name: @activity_type.name } }
