...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { comments: @request.comments, commission_type_id: @request.commission_type_id, contact_address: @request.contact_address, due_date: @request.due_date, fullname: @request.fullname } }
