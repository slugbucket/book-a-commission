...
ActivityType.create(name: 'Commissions', description: 'Commissioned artworks', color: 'LightRed')
ActivityType.create(name: 'Teaching', description: 'Individual and group tuition', color: 'Lilac')
ActivityType.create(name: 'Paperwork', description: 'Admin, taxes and postage', color: 'Grey')
